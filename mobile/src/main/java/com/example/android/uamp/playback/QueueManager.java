...
public class QueueManager {
    ...
    public void updateMetadata() {
        ...
        if (metadata.getDescription().getIconBitmap() == null &&
            ...
            Glide.with(mContext).load(albumUri).asBitmap()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(new SimpleTarget<Bitmap>(AlbumArtConstants.MAX_ART_WIDTH, AlbumArtConstants.MAX_ART_HEIGHT) {
                @Override
                public void onResourceReady(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
                    mMusicProvider.updateMusicArt(musicId, bitmap);
            ...
            Glide.with(mContext).load(albumUri).asBitmap()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(new SimpleTarget<Bitmap>(AlbumArtConstants.MAX_ART_WIDTH_ICON, AlbumArtConstants.MAX_ART_HEIGHT_ICON) {
                        @Override
                        public void onResourceReady(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
                            mMusicProvider.updateMusicArtIcon(musicId, bitmap);
                        }
                    });
